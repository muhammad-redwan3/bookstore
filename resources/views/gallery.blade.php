                                    ...
                                    <div>
                                        <div class="card-img-actions">
                                            <a href="{{ route('book.details',[$book->id,$book->slug]) }}">
                                                <img src="{{ getImage($book->cover_image) }}" class="card-img img-fluid"
                                    ...
                                    <div class="card-body bg-light text-center">
                                        <div class="mb-2">
                                            <h6 class="font-weight-semibold card-title mb-2"><a
                                                    href="{{ route('book.details', [$book->id,$book->slug]) }}"
                                                    class="text-default mb-0" data-abc="true">{{ $book->title }}</a>
                                            </h6>
                                            <a href="{{ route('gallery.categories.show',[$book->category->id,$book->category->slug]) }}"
